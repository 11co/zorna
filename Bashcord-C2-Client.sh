...
token="MTQxMjUwNzk3MDkzOTM5MjA5NA.GpuF3L.3SxAJvKU79G0RHuvrPTpHN4RfhvTdUMTUXJVYo" # Your bot intents should be on and 'read messages' permissions when joining your server
chan="1414284903696044313" # On Discord app rightclick the channel > 'Copy Channel ID' (Make sure the bot can access this channel)
bot_id="1412507970939392094" # Settings > Advanced > Developer mode ON -- then On Discord app rightclick the bot > 'Copy User ID' 
